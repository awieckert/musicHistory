...
INSERT INTO Label VALUES (null, 'Super-Awesome Label');
INSERT INTO Label VALUES (null, 'Monkey Butt');
INSERT INTO Label VALUES (null, 'Jazz-tastic Records');
INSERT INTO Label VALUES (null, 'Bomb Trax');
INSERT INTO Label VALUES (null, 'Should We Produce This? Records');
INSERT INTO Label VALUES (null, 'La La Land');
INSERT INTO Label VALUES (null, 'Questionable Decisions');
...
INSERT INTO Album
	SELECT null,
		   ...
		   ArtistId,
		   g.GenreId
	FROM Artist a, Genre g, Label l WHERE a.ArtistName = "Avett Brothers" AND g.Label = "Folk" and l.LabelId = "Super-Awesome Label";
...
INSERT INTO Album
	SELECT null,
		   ...
		   ArtistId,
		   g.GenreId
	FROM Artist a, Genre g, Label l WHERE a.ArtistName = "Avett Brothers" AND g.Label = "Folk" and l.LabelId = "Jazz-tastic Recrods";
...
INSERT INTO Album
	SELECT null,
		   ...
		   ArtistId,
		   g.GenreId
	FROM Artist a, Genre g, Label l WHERE a.ArtistName = "Avett Brothers" AND g.Label = "Folk" and l.LabelId = "Monkey Butt";
...
INSERT INTO Album
	SELECT null,
		   ...
		   ArtistId,
		   g.GenreId
	FROM Artist a, Genre g, Label l WHERE a.ArtistName = "Avett Brothers" AND g.Label = "Folk" and l.LabelId = "Bomb Trax";
...
INSERT INTO Album
	SELECT null,
		   ...
		   ArtistId,
		   g.GenreId
	FROM Artist a, Genre g, Label l WHERE a.ArtistName = "Avett Brothers" AND g.Label = "Folk" and l.LabelId = "Should We Produce This? Records";
...
INSERT INTO Album
	SELECT null,
		   ...
		   ArtistId,
		   g.GenreId
	FROM Artist a, Genre g, Label l WHERE a.ArtistName = "Avett Brothers" AND g.Label = "Folk" and l.LabelId = "Questionable Decisions";



INSERT INTO Album VALUES (null, "Revolver", '08/05/1966', 2083, 3, 6, 2);
INSERT INTO Album VALUES (null, "Sgt. Pepper's Lonely Hearts Club Band", '06/01/1967', 2392, 1, 6, 2);
INSERT INTO Album VALUES (null, "Magical Mystery Tour", '11/27/1967', 1148, 2, 6, 2);

INSERT INTO Album VALUES (null, 'Screaming for Vengeance', '06/17/1982', 2322, 1, 1, 2);
...
INSERT INTO Album VALUES (null, 'Round About Midnight', '03/06/1957', 2327, 7, 24, 4);
INSERT INTO Album VALUES (null, 'Miles Ahead', '10/21/1957', 2132, 5, 24, 4);
INSERT INTO Album VALUES (null, 'Milestones', '09/02/1958', 2856, 2, 24, 4);

INSERT INTO Album VALUES (null, "Moanin' in the Moonlight", '05/14/1959', 2033, 3, 7, 3);
INSERT INTO Album VALUES (null, "Howlin' Wolf", '10/21/1957', 1917, 6, 7, 3);
INSERT INTO Album VALUES (null, "The Howlin' Wolf Album", '09/02/1969', 2459, 7, 7, 3);
...
INSERT INTO Album
  SELECT null, "Eliminator", '3/23/1983', 2668,
		   ...
		   ArtistId,
		   g.GenreId
	FROM Artist a, Genre g, Label l WHERE a.ArtistName = "Avett Brothers" AND g.Label = "Folk" and l.LabelId = "La La Land";
...
INSERT INTO Album VALUES (null, "Damaged", '12/05/1981', 2098, 1, 8, 9);
INSERT INTO Album VALUES (null, "TV Party", '07/12/1982', 409, 2, 8, 9);
...
select a.Title 'Album', l.LabelName
